...
def _build_pattern_set() -> frozenset[str]:
    ...
    all_lists = [
        TAINT_SOURCES, JS_TAINT_SOURCES, JAVA_TAINT_SOURCES,
        GO_TAINT_SOURCES, RUBY_TAINT_SOURCES, C_TAINT_SOURCES,
        RUST_TAINT_SOURCES, BASH_TAINT_SOURCES,
        TAINT_SINKS, JS_TAINT_SINKS, JAVA_TAINT_SINKS,
        GO_TAINT_SINKS, RUBY_TAINT_SINKS, C_TAINT_SINKS,
        RUST_TAINT_SINKS, BASH_TAINT_SINKS, EXTRA_SINKS,
        SANITIZERS, JS_SANITIZERS, JAVA_SANITIZERS,
        GO_SANITIZERS, RUBY_SANITIZERS, C_SANITIZERS,
        RUST_SANITIZERS, BASH_SANITIZERS, EXTRA_SANITIZERS,
    ]
